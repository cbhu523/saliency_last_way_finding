...
class BinaryClassifierViewer(QWidget):
    ...
    def init_widgets(self):
        ...
        #self.label_confirm.setFont(QFont("Roman times",20,QFont.Bold))
        ...
        #self.label_confirm.setPointSize(12)
        ...
        #self.label_confirm.setFont(self.font_button)
        self.label_confirm.setFont(QFont("Roman times", 20))
        ...
        self.hbox_foot.addWidget(self.label_confirm, 0, Qt.AlignRight)
